...
from PySide6.QtGui import QFont, QAction, QKeySequence, QPalette
...
class TaskItemWidget(QWidget):
    ...
    def _update_style(self):
        ...
        # Use palette to get theme-appropriate colors
        ...
        # Also style the time label if present
        if hasattr(self, 'time_label'):
            # Use a slightly dimmed color for time (mid from palette)
...
class WeeklyTaskMonitor(QMainWindow):
    def __init__(self):
        ...
        # Apply theme before creating toolbar so toolbar gets correct colors
    ...
    def _toggle_theme(self, checked):
        ...
        self._apply_theme(self.dark_mode)
        self._refresh_view()  # Force task widgets to update their colors
    ...
    def _populate_day_list(self, day_index: int, tasks: List[Tuple]):
        ...
        for task in tasks:
            ...
            # Adjust item size to fit the widget's content
    ...
    def _on_task_toggled(self, task_id: int, completed: bool):
        ...
        self._refresh_view()  # update status bar
